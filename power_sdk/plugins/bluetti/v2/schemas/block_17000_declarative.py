...
Source: ProtocolParserV2.smali lines 745-877 (atsInfoParse)
Bean: DeviceAtsInfo
...
@block_schema(
    block_id=17000,
    name="ATS_INFO",
    description="Automatic Transfer Switch device information (smali-verified)",
    min_length=26,
...
@dataclass
class ATSInfoBlock:
    """ATS device information schema (smali-verified)."""
