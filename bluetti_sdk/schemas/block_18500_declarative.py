...
@block_schema(
    ...
    description="EPAD liquid measurement point 2 (provisional - no parse method)",
    min_length=100,
    protocol_version=2000,
    strict=False,
)
@dataclass
class EPadLiquidPoint2Block:
    """EPAD liquid measurement point 2 schema (provisional baseline).
...
BLOCK_18500_SCHEMA = EPadLiquidPoint2Block.to_schema()  # type: ignore[attr-defined]
