...
@block_schema(
    ...
    description="EPAD liquid measurement point 3 (provisional - no parse method)",
    min_length=100,
    protocol_version=2000,
    strict=False,
)
@dataclass
class EPadLiquidPoint3Block:
    """EPAD liquid measurement point 3 schema (provisional baseline).
...
BLOCK_18600_SCHEMA = EPadLiquidPoint3Block.to_schema()  # type: ignore[attr-defined]
