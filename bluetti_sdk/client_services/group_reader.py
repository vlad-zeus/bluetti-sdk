...
Extracted from V2Client to reduce god object complexity.
...
class GroupReader:
    ...
    This service extracts group orchestration logic from V2Client:
    ...
    def __init__(
        ...
        Args:
            ...
            read_block_fn: Block read function (injected from V2Client)
        """
